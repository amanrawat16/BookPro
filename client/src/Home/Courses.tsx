...
export function Courses({code,branch,session,semester,updateFields}:CourseFormProps){
    ...
    return(
        ...
        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required type="text" value={branch} onChange={e => 
